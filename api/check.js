...
async function checkNearestDay() {
    ...
    payload.append('date', '26-11-2025'); // DD-MM-YYYY format

    console.log("📅 Requesting nearest day with date: 26-11-2025");
...
async function performCheck() {
    try {
        ...
        if (result.status === "OK" && result.data?.day) {
            ...
            const targetDate = new Date(2025, 10, 26); // October 1st, 2025 (month is 0-indexed)
